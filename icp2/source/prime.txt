...
public class PrimeNumbers{
 ...
 job.setJarByClass(PrimeNumbers.class);
 job.setMapperClass(PrimeNumbers.TokenizerMapper.class);
 job.setCombinerClass(PrimeNumbers.IntSumReducer.class);
 job.setReducerClass(PrimeNumbers.IntSumReducer.class);
